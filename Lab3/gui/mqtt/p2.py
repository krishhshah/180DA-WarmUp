...
while running:
    ...
    if not result_ready and result == 0:
        choose_results_text = font.render('Waiting for Player 1...', True, (0,0,0), (255,255,255))
    elif result_ready:
        if result == 1:
            p1_win += 1
            choose_results_text = font.render(f'You lose! Player 1 chose {p1_move}', True, (0,0,0), (255,255,255))
        elif result == 2:
            p2_win += 1
            choose_results_text = font.render(f'You win! Player 1 chose {p1_move}', True, (0,0,0), (255,255,255))
        elif result == 3:
            tie += 1
            choose_results_text = font.render(f'It was a tie! You both chose {p1_move}', True, (0,0,0), (255,255,255))
        first_run = False
        start = time.time()
        result_ready = False
        result = 4
